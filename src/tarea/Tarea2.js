...
export function MatchNombre(props) {
  ...
  return (
    <input
      className={value === nombre ? "input input-match" : "input"}
      value={value}
...
export function PasswordInput(props) {
  ...
  return (
    <input
      type="password"
      className={value.length < minLength ? "input input-match" : "input"}
      value={value}
      onChange={(e) => setValue(e.target.value)}
    />
  );
...
export function ValidationInput(props) {
  ...
  return (
    <input
      ...
      className={validation(value) ? "input" : "input input-match"}
      value={value}
      onChange={(e) => setValue(e.target.value)}
    />
  );
